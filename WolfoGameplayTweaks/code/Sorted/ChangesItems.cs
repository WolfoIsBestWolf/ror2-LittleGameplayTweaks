...
namespace LittleGameplayTweaks
{
    public class ChangesItems
    {
        ...
        public static void Items()
        {
            ...
            if (WConfig.ItemSquidMechanical.Value == true)
            {
            ...
            //Laser Scope 15
            if (WConfig.ItemsScopeBuff.Value == true)
            {
        ...
        {
            //Mostly joking buff to Defense Neuclus
            ...
            //itemDefInfos = itemDefInfos.Add(new GivePickupsOnStart.ItemDefInfo { itemDef = DLC1Content.Items.MinorConstructOnKill, count = 1 });
