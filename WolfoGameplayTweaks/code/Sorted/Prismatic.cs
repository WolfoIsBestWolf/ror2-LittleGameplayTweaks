...
namespace LittleGameplayTweaks
{
    public class Prismatic
    {
        ...
        {
            //Rect rec128 = new Rect(0, 0, 128, 128);
            ...
            ruleChoiceDef5.tooltipNameToken = "Remix";
            ruleChoiceDef5.tooltipBodyToken = "The Prismatic Trial will not end on it's own\nBosses will start being elite on Stage 4";
            ...
            ruleChoiceDef4.tooltipNameToken = "Vanilla";
            ruleChoiceDef4.tooltipBodyToken = "The Prismatic Trial will end after beating Stage 2.\nBosses will be elite on Stage 2";
