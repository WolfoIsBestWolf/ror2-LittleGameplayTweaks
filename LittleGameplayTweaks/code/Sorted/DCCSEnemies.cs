...
namespace LittleGameplayTweaks
{
    ...
    {
        public static int loopL = 0;
        public static int loopNL = 0;
        ...
        public static void Start()
        {
            ...
            if (WConfig.DCCSEnemyChangesLooping.Value == false)
            {
                loopL = 9000;
            }
        ...
        public static void SulfurPoolsBeetle()
        {
            ...
            FamilyDirectorCardCategorySelection dccsBeetleSulfurFamily = Addressables.LoadAssetAsync<FamilyDirectorCardCategorySelection>(key: "RoR2/Base/Common/dccsBeetleFamilySulfur.asset").WaitForCompletion();
        ...
        public static void Enemies_Stage1()
        {
            ...
            {
                num = FindSpawnCard(dccsGolemplainsMonstersDLC1.categories[0].cards, "MegaConstruct");
                if (num > -1)
                {
            ...
            if (ConfigStages.Stage_1_Snow.Value)
            {
                ...
                if (num > -1)
                {
                    dccsSnowyForestMonstersDLC1.categories[1].cards[num].minimumStageCompletions = 2;
                }
                ...
                dccsSnowyForestMonstersDLC2.AddCard(1, cscBison);
            ...
            {
                dccsVillageNightMonsters_Additional.AddCard(0, cscHalcy);
        ...
        public static void Enemies_Stage2()
        {
            ...
            {
                dccsLemurianTempleMonsters.AddCard(0, cscGrovetender);
                dccsLemurianTempleMonsters.AddCard(1, LoopBison); //Loop Bisons
                dccsLemurianTempleMonstersDLC1.AddCard(1, LoopBell); //Loop Bells
                ...
                dccsLemurianTempleMonstersDLC1.categories[0].cards[0].selectionWeight = 0;  //Vermin
                dccsLemurianTempleMonstersDLC1.categories[0].cards[0].selectionWeight = 0; //NO Pests
            }
            #endregion
        }
        ...
        public static void Enemies_Stage3()
        {
            ...
            DirectorCard cscMagmaWorm = new DirectorCard
            {
            ...
            DirectorCard cscMushroom = new DirectorCard
            {
            ...
            {
                dccsFrozenWallMonsters.categories[0].cards[0] = cscRoboBallBoss; //Clay Dunestrider replaced by Solus Unit
                dccsFrozenWallMonsters.AddCard(1, LoopRoboBallMini);
                dccsFrozenWallMonsters.AddCard(2, LoopVulture); //Like the Big Ball leads them to it so they can eat more People and Iron                                               
            }

            if (ConfigStages.Stage_3_Wisp.Value)
            {
                dccsWispGraveyardMonsters.AddCard(1, cscClayGrenadier);
                dccsWispGraveyardMonsters.AddCard(2, LoopPest);
            }
            ...
            if (ConfigStages.Stage_3_Sulfur.Value)
            {
                ...
                dccsSulfurPoolsMonstersDLC1.AddCard(0, cscMagmaWorm);  //Sulfur, Fire, yknow?
                dccsSulfurPoolsMonstersDLC1.AddCard(0, cscElectricWorm);  
                dccsSulfurPoolsMonstersDLC1.AddCard(1, cscHermitCrab); //Seems fitting for another trash mob
                dccsSulfurPoolsMonstersDLC1.AddCard(1, cscAcidLarva); //Seems fitting for another trash mob
            ...
            if (ConfigStages.Stage_3_Tree.Value)
            {
                ...
                dccsHabitatfallMonsters_DLC1.AddCard(2, cscMushroom); //Mushroom biome but no mushroom enemy??
            }
            #endregion
        }
        ...
        public static void Enemies_Stage4()
        {
            ...
            if (ConfigStages.Stage_4_Root_Jungle.Value)
            {
                ...
                dccsRootJungleMonsters.categories[1].cards[0].spawnCard = Addressables.LoadAssetAsync<SpawnCard>(key: "RoR2/Base/Golem/cscGolemNature.asset").WaitForCompletion();
                //Skinned Golem
                ...
                dccsRootJungleMonstersDLC2.categories[0].cards[0].selectionWeight = 0; //Damn Halcyonite
            }
        ...
        public static void Enemies_Stage5()
        {
            ...
            DirectorCard LoopHalcy = new DirectorCard
            {
                spawnCard = Addressables.LoadAssetAsync<CharacterSpawnCard>(key: "RoR2/DLC2/Halcyonite/cscHalcyonite.asset").WaitForCompletion(),
                preventOverhead = false,
                selectionWeight = 2,
            ...
            if (ConfigStages.Stage_5_Sky.Value)
            {
                ...
                dccsSkyMeadowMonstersDLC1.AddCard(0, LoopVoidDevestator);
            }
            ...
            if (ConfigStages.Stage_5_Helminth.Value)
            {
                ...
                dccsHelminthRoostMonsters.AddCard(1, LoopHalcy);
            }
        ...
        public static void Enemies_MiscPools()
        {
            ...
            DirectorCard CampMoreDevestators = new DirectorCard
            {
                spawnCard = Addressables.LoadAssetAsync<CharacterSpawnCard>(key: "RoR2/DLC1/VoidMegaCrab/cscVoidMegaCrab.asset").WaitForCompletion(),
                selectionWeight = 3,
                preventOverhead = true,
            ...
            DirectorCard CampMoreDevestators2 = new DirectorCard
            {
                spawnCard = Addressables.LoadAssetAsync<CharacterSpawnCard>(key: "RoR2/DLC1/VoidMegaCrab/cscVoidMegaCrab.asset").WaitForCompletion(),
                selectionWeight = 6,
                preventOverhead = true,
            ...
            DirectorCard ShrineMoreHalcy2 = new DirectorCard
            {
                spawnCard = Addressables.LoadAssetAsync<CharacterSpawnCard>(key: "RoR2/DLC2/Halcyonite/cscHalcyonite.asset").WaitForCompletion(),
                preventOverhead = false,
                selectionWeight = 4,
            ...
            dccsVoidCampMonsters.AddCard(0, CampMoreDevestators);
            dccsVoidCampMonsters.AddCard(0, CampMoreDevestators2);
            ...
            if (WConfig.InteractableHalcyShrineHalcy.Value)
            {
                ...
                dccsShrineHalcyoniteActivationMonsterWave.AddCard(0, ShrineMoreHalcy);
                dccsShrineHalcyoniteActivationMonsterWave.AddCard(0, ShrineMoreHalcy2);
            }
            #endregion
        }
