...
namespace LittleGameplayTweaks
{
    public class InteractableFamilyEvents
    {
        ...
        private static WeightedSelection<DirectorCardCategorySelection> DccsPool_GenerateWeightedSelection(On.RoR2.DccsPool.orig_GenerateWeightedSelection orig, DccsPool self)
        {
            var a = orig(self);
        ...
        public static void Add()
        {
            ...
            DccsPool.Category ExtraCategory = new DccsPool.Category { categoryWeight = 0.005f, name = "Family", alwaysIncluded = new DccsPool.PoolEntry[] {
