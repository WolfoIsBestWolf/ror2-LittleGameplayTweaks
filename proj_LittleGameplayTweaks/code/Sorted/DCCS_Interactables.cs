...
namespace LittleGameplayTweaks
{
    public class DCCS_Interactables
    {
        ...
        {
            if (!WConfig.cfgMatchCategory.Value)
            {
                return;
            }
            ...
            switch (scene)
            {
                ...
                case "dampcavesimple": //4
                    DCCS.MatchCategoryChests(dccs, card, DCCS.Category.Damage);
                    break;
                case "golemplains":
                case "village":
                case "villagenight":
                ...
                case "sulfurpools":
                case "shipgraveyard":
                    DCCS.MatchCategoryChests(dccs, card, DCCS.Category.Healing);
                    break;
                case "blackbeach":
                case "lakes":
                case "lakesnight":
                ...
                case "frozenwall":
                case "rootjungle":
                    DCCS.MatchCategoryChests(dccs, card, DCCS.Category.Utility);
                    break;
            }
        ...
        public static void Interactables_Other()
        {
            ...
            DirectorCardCategorySelection.Category GoldShoreShrines = new DirectorCardCategorySelection.Category
            {
                name = "Shrines",
                selectionWeight = 10,
                cards = new DirectorCard[] { AdShrineCombat, ADShrineChance, ADShrineCleanse1, ADShrineHealing , ADBARREL }
            };
