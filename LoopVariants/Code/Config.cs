...
namespace LoopVariants
{
    public class WConfig
    {
        ...
        private static void Monster_Additions_SettingChanged(object sender, System.EventArgs e)
        {
            ...
            {
                LoopVariantsMain.AddMonsters = BepInEx.Bootstrap.Chainloader.PluginInfos.ContainsKey("com.Wolfo.LittleGameplayTweaks");
            }
        ...
        public static void InitConfigStages()
        {
            ...
            Stage_1_Roost = ConfigFileSTAGES.Bind(
                ...
                "Distant Roost",
                true,
                "Enable alt weather for this stage. WIP/Not implemented"
            );
